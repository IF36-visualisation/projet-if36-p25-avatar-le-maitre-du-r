...
##Evolution des tags
Dans cette partie on reviendra sur les tags les plus présents en fonction des années de sortie. Pour cela on prend les 10 tags les plus utilisé globalement et on regade leurs évolution.
...
### Interprétation
On se concentrera sur les 2 grpahiques de focus sur les périodes avant et après 2013. 
Ici on voit apparaitre le best seller de l'année. On peut donc estimer si le jeu en question à une relation avec les jeux sorties cette année. 

Par exemple certain jeux n'ont rien à voir avec les "gros" tags des jeux sorties cette année là. Par exemple Left 4 dead 1 et 2 en 2008 et 2009 se retrouve uniquement dans 2 tags (Action et multiplayer). On pourrait donc estimer que c'est un bon jeux malgré qu'il n'ai pas forcément surfer sur la vague du moment. 
